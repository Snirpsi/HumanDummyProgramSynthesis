...
if __name__ == '__main__':
    ...
    words = [w for w in words if len(w) > 31]
    words = [w for w in words if len(w) > 32]
    words = [w for w in words if len(w) > 33]
    words = [w for w in words if len(w) > 34]
    words = [w for w in words if len(w) > 35]
