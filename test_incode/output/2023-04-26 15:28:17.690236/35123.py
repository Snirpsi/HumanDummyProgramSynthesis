...
if __name__ == '__main__':
    """ A minimal webserver that returns a list of words or converts a list of words. """    
    ...
    if len(sys.argv) > 1:
        ...
        words = ['python', 'flask', 'flask-restful', 'flask-sqlalchemy', 'flask-admin', 'flask-restful-swagger']
